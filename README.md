...
## Overview
An Excel-based analysis and dashboard exploring 5 years of daily electricity generation data for Great Britain, analysing the relationship between renewable generation, carbon intensity, and seasonal demand patterns. ![Dashboard screenshot](dashboard.png)
